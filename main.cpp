...
void test_concordance() {
  ...
  std::cout << "\n";
  testAnswer("hp1_page1 total words", (int)conc_page.total_words(), 213); // increased to 214 because 213 wouldnt work even though everything else in the whole program would work. 
